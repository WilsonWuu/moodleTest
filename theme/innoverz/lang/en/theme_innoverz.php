...
$string['pluginname'] = 'innoverz theme';
$string['configtitle'] = 'innoverz theme';
$string['choosereadme'] = 'innoverz theme extended from Moove';

$string['frontpageslidersettings'] = 'Frontpage Sliders';

$string['region-front-center'] = 'Home frontpage - Promotion';

$string['sliderimagedesc'] = 'Add an image for your slide.';

$string['important-notices'] = 'Important Notices';
