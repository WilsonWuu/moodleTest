...
require(['jquery'], function ($) {
  ...
  $(window).on("unload", function () {
    ...
    $.ajax({
      ...
      async: false,
      data: "id=" + pvid + "&duration=" + duration,
      //pvid come from /lib/outputrenderers.php : 796
