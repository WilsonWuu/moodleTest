...
$reportname = 'visitsdurationreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/visitsduration/index.php';
...
$renderer = new reportvisitsduration_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportvisitsduration_get_records($data);
