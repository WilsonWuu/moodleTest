...
$reportname = 'visitsfrequencyreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/visitsfrequency/index.php';
...
$renderer = new reportvisitsfrequency_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportvisitsfrequency_get_records($data);
