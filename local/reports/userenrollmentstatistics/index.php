...
$isprintfriendly = optional_param('download', 0, PARAM_INT);

$reportname = 'userenrollmentstatisticsreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/userenrollmentstatistics/index.php';
...
$renderer = new reportuserenrollmentstatistics_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportuserenrollmentstatistics_get_records($data);
