...
$reportname = 'kmpagehitsreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/kmpagehits/index.php';
...
$renderer = new reportkmpagehits_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportkmpagehits_get_records($data);
