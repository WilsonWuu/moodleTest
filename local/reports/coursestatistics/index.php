...
require_once(__DIR__ . '/../coursestatistics/lib.php');
require_once(__DIR__.'/../report_search_form.php');

$isdownload = optional_param('download', 0, PARAM_INT);

$reportname = 'coursestatisticsreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/coursestatistics/index.php';
...
$renderer = new reportcoursestatistics_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportcoursestatistics_get_records($data);
...
$PAGE->requires->js('/local/reports/coursestatistics/index.js');
