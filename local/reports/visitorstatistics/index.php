...
$reportname = 'visitorsstatisticsreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/visitorstatistics/index.php';
...
$renderer = new reportvisitorstatistics_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportvisitorstatistics_get_visits($data);
