...
$reportname = 'librarypagehitsreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/librarypagehits/index.php';
...
$renderer = new reportlibrarypagehits_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportlibrarypagehits_get_records($data);
