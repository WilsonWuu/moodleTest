...
$reportname = 'userlastvisitsreport';

$context = context_system::instance();
$pagesuburl = '/local/reports/userlastvisits/index.php';
...
$renderer = new reportuserlastvisits_renderer();
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportuserlastvisits_get_records($data);
...
$PAGE->requires->js('/local/reports/userlastvisits/index.js');
