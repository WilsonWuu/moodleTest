...
$pagesuburl = '/local/reports/learningresources/index.php';
...
$renderer = new reportlearningresources_renderer();
$form = new report_search_form(null, null, 'post', '', array('class'=>'searchform'));
$reportcontent = '';
$heading = get_string('learningresourcesstatisticsreport','local_reports');
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportlearningresources_get_resources($data);
...
//admin_externalpage_setup('learningresourcesstatistics');
