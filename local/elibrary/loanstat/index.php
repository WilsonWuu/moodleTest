...
$pagesuburl = $CFG->LIBRARY_BASEURL.'loanstat/index.php';
...
$renderer = new reportloan_renderer();
$form = new report_search_form(null, null, 'post', '', array('class'=>'searchform'));
$reportcontent = '';
$heading = get_string('loanstatisticsreport', 'local_elibrary');
...
if ($isdownload && confirm_sesskey()) {
	...
	$records = reportloan_get_resources($data);
...
//admin_externalpage_setup('elibraryloanstatisticsreport');

$PAGE->requires->js($CFG->LIBRARY_BASEURL.'loanstat/index.js');
