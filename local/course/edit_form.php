...
require_once('../../config.php');  //innoverz
require_once($CFG->dirroot . '/course/edit_form.php');  //innoverz

require_once($CFG->libdir.'/formslib.php');
require_once($CFG->libdir.'/formslib.php');
require_once($CFG->libdir.'/completionlib.php');
class local_course_edit_form extends course_edit_form {
    ...
    function definition() {
        ...
        $mform->addElement('selectyesno', 'autoarchive', get_string('autoarchive','local_course'));
        $mform->setDefault('autoarchive', true);
